...
namespace Weatherstation.Features.Sensors.Presentation
{
    ...
    {
        private readonly ISensorsLoader _sensorsLoader;

        public SensorsController(ISensorsLoader sensorsLoader)
        {
            _sensorsLoader = sensorsLoader;
        }
        ...
        public async Task<IActionResult> MySensors()
        {
            ...
            var sensors = await _sensorsLoader.GetAllSensorsForUserAsync(userId);
